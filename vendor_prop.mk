PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    persist.sys.cam.ai.recognition=true \
    ...
    ro.audio.auto.test=true \
    ro.bt.bdaddr_path=/data/misc/bluedroid/btmac.txt \
    ro.btwifisoftap.coexist=true \
    ro.call.custom.num.show.name=true \
    ro.call.show.emergency.number=true \
    ro.carrier=unknown \
    ro.com.android.dataroaming=false \
    ro.com.google.clientidbase=android-transsion-itel-rev2 \
    ro.com.google.gmsversion=8.1_201808.go \
    ro.config.alarm_alert=Alarm_Beep_03.ogg \
    ro.config.default_message0=Merope.ogg \
    ro.config.default_message1=Merope.ogg \
    ro.config.default_message=Merope.ogg \
    ...
    ro.rm.mobile.usage.data.menu=true \
    ...
    ro.tsl.device.name=itel \
    ro.tsl.number.code=true \
    ro.tsl.power.ui=true \
